...
var selectRandomMeat = function() {
  ...
  pizzaElementGenerator = function(e) {
    ...
    a.appendChild(r),
    i.style.width = "65%",
    (t = document.createElement("h4")).innerHTML = randomName(),
    i.appendChild(t),
    (o = document.createElement("ul")).innerHTML = makeRandomPizza(),
    i.appendChild(o),
    a.appendChild(i),
    a
  },
...
document.addEventListener("DOMContentLoaded", function() {
  for (var e = 0; e < 200; e++) {
    ...
    a.className = "mover",
    a.src = "images/pizza.png",
    a.style.height = "100px",
    a.style.width = "73.333px",
    a.basicLeft = e % 8 * 256,
    a.style.top = 256 * Math.floor(e / 8) + "px",
    document.querySelector("#movingPizzas1").appendChild(a)
  }
  updatePositions()
});
